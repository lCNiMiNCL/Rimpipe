...
> 本文档收录 RimPipe 的核心架构、公式、锁定决议、横切规则与阶段设计。
...
### 7.10 决议：4.10 局部脏区拓扑 — DirtyTopo（已锁定 · 2026-07-20；本体已实现 · 0.4.7）

> 本节保留从“延后”到“实施”的完整决策过程；最终 DirtyTopo 已在 0.4.7 实现并通过验收。
