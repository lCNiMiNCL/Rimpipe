...
public class CompProperties_PipeBreachable : CompProperties
{
	...
	public CompProperties_PipeBreachable()
	{
		compClass = typeof(CompPipeBreachable);
	}
	...
	public override IEnumerable<string> ConfigErrors(ThingDef parentDef)
	{
		...
		{
			yield return "CompProperties_PipeBreachable.breachBelowHitPointsPercent 须在 [0,1]。";
		}
	}
}
